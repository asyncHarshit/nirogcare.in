    ...
    <div className="space-y-4 text-white">
      ...
      <div className="bg-gray-900/50 p-4 rounded-xl border border-green-600/20 space-y-3">
        <div className="flex items-center gap-2">
          ...
          <span>Name:</span>
          <span className="ml-2 font-medium">{lab.name || 'N/A'}</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <span>License :</span>
          <span className="ml-2 font-medium">{lab.licenseNumber}</span>
        </div>

        <div className="flex items-center gap-2">
          <MapPin className="w-5 h-5 text-cyan-400" />
          <span>Address:</span>
          <span className="ml-2 font-medium">{lab.address}</span>
        </div>

        <div className="flex items-center gap-2">
          <FlaskConical className="w-5 h-5 text-green-400" />
          <span>Test Types:</span>
          <span className="ml-2 font-medium">{lab.testTypes?.join(', ') || 'None'}</span>
        </div>
      </div>
    </div>
  );
