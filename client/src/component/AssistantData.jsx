...
import { Building2, UserPlus, Stethoscope, Hash } from 'lucide-react';

const InfoField = ({ icon: Icon, label, value }) => (
  <div className="group mb-6">
    <div className="flex items-center text-base text-gray-300 group-hover:text-green-300 transition-colors">
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="w-full max-w-2xl">
        <div className="mt-16 bg-gradient-to-br from-gray-900 via-black to-gray-800 rounded-3xl shadow-2xl p-10 border border-green-500/20 backdrop-blur-md">
          ...
          {/* Doctor Info */}
          <div className="mb-10">
            <h3 className="text-xl text-white font-semibold mb-4 underline underline-offset-4">Doctor Information</h3>
          ...
          {/* Hospital Info */}
          <div>
            <h3 className="text-xl text-white font-semibold mb-4 underline underline-offset-4">Hospital Information</h3>
